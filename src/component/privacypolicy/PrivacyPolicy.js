    ...
    <div className="privacy-policy-container">
      <div className="privacy-policy-content">
        ...
        <section className="policy-section">
          ...
          <p>Welcome to Codeknight Esports. We respect your privacy and are committed to protecting your personal data. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you:</p>
          <ul>
        ...
        <section className="policy-section">
          ...
          <p>To exercise these rights, contact: <a href="mailto:privacy@codeknightesports.com">privacy@codeknightesports.com</a></p>
        </section>
        ...
        <section className="policy-section">
          ...
          <div className="contact-info">
            <p><strong>Codeknight Esports</strong></p>
            <p>📧 <a href="mailto:privacy@codeknightesports.com">privacy@codeknightesports.com</a></p>
            <p>🌐 <a href="https://www.codeknightesports.in" target="_blank" rel="noopener noreferrer">www.codeknightesports.in</a></p>
          </div>
        </section>
      </div>
    </div>
